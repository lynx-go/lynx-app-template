...
func (_u *RefreshTokenUpdate) SetNillableUpdatedAt(v *time.Time) *RefreshTokenUpdate {
	if v != nil {
		_u.SetUpdatedAt(*v)
	}
	return _u
...
// SetNillableUpdatedAt sets the "updated_at" field if the given value is not nil.
func (_u *RefreshTokenUpdateOne) SetNillableUpdatedAt(v *time.Time) *RefreshTokenUpdateOne {
	if v != nil {
		_u.SetUpdatedAt(*v)
	}
	return _u
...
func (_u *RefreshTokenUpdateOne) sqlSave(ctx context.Context) (_node *RefreshToken, err error) {
	...
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`gen: missing "RefreshToken.id" for update`)}
	}
