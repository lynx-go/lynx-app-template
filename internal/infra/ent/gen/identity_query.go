...
func (_q *IdentityQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *IdentityQuery) FirstIDX(ctx context.Context) int64 {
...
func (_q *IdentityQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *IdentityQuery) OnlyIDX(ctx context.Context) int64 {
...
func (_q *IdentityQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (_q *IdentityQuery) IDsX(ctx context.Context) []int64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *IdentityQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(identity.Table, identity.Columns, sqlgraph.NewFieldSpec(identity.FieldID, field.TypeInt64))
	_spec.From = _q.sql
