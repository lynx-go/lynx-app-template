...
import (
	...
	"github.com/lynx-go/lynx-app-template/internal/infra/ent/gen"
)

// The IdentityFunc type is an adapter to allow the use of ordinary
// function as Identity mutator.
type IdentityFunc func(context.Context, *gen.IdentityMutation) (gen.Value, error)

// Mutate calls f(ctx, m).
func (f IdentityFunc) Mutate(ctx context.Context, m gen.Mutation) (gen.Value, error) {
	if mv, ok := m.(*gen.IdentityMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *gen.IdentityMutation", m)
}

// The RefreshTokenFunc type is an adapter to allow the use of ordinary
// function as RefreshToken mutator.
type RefreshTokenFunc func(context.Context, *gen.RefreshTokenMutation) (gen.Value, error)

// Mutate calls f(ctx, m).
func (f RefreshTokenFunc) Mutate(ctx context.Context, m gen.Mutation) (gen.Value, error) {
	if mv, ok := m.(*gen.RefreshTokenMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *gen.RefreshTokenMutation", m)
}

// The RuntimeVarFunc type is an adapter to allow the use of ordinary
// function as RuntimeVar mutator.
type RuntimeVarFunc func(context.Context, *gen.RuntimeVarMutation) (gen.Value, error)

// Mutate calls f(ctx, m).
func (f RuntimeVarFunc) Mutate(ctx context.Context, m gen.Mutation) (gen.Value, error) {
	if mv, ok := m.(*gen.RuntimeVarMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *gen.RuntimeVarMutation", m)
}
